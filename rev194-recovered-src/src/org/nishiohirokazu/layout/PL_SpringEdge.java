...
public class PL_SpringEdge extends PhysicalLaw {
	...
	private double getSpringStrength(IEdge e){
		if(springStrength.containsKey(e)){
			return springStrength.get(e);
		}
		return defaultSpringStrength;
	}
	
	private double getNormalLength(IEdge e){
		if(normalLength.containsKey(e)){
			return normalLength.get(e);
		}
		return defaultNormalLength;
	}
	...
	public void setDefaultNormalLength(Object o){
		defaultNormalLength = UtilCast.o2double(o); 
	}
	public void setDefaultSpringStrength(Object o){
		defaultSpringStrength = UtilCast.o2double(o); 
	}
