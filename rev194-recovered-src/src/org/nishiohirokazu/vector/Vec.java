...
public class Vec {
	...
	public static double[] translate2DVec(double[] axis1, double v1,
			double[] axis2, double v2) {
	...
	public static double[] addX(double[] v, double i) {
		double[] result = {v[0] + i, v[1]};
		return result;
	}
