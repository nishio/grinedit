...
public class MouseOperation {
	...
	public void mouseDown(int x, int y, int i) {
	}

	public void mouseUp(int x, int y, int i) {
	}

	public void mouseMove(int x, int y, int i) {
	}

	public void mouseDrag(int x, int y, int i){
	}
